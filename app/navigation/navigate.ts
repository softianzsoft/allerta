...
const openForgetPwd = (navigation) => (props = {}) => {
  navigation.push("ForgetPwd", props);
};
const openCustomPage = (navigation) => (props = {}) => {
  navigation.push("CustomPageScreen", props);
};
...
const navigate = (navigation) => ({
  ...
  openForgetPwd: navigateOneTime(openForgetPwd(navigation)),
  openCustomPage: navigateOneTime(openCustomPage(navigation)),
});
